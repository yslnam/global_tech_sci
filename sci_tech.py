...
# Write CSV
csv_file = open('sci_tech.csv', 'w', encoding='utf-8')
...
while True:
    try:
        driver.get(f"https://www.ted.com/talks?language=en&page={p}&sort=newest&topics%5B%5D=Technology&topics%5B%5D=Science")
        p += 1
    except:
        break
